...
public class WomenPage {
    ...
    @FindBy(css = "a[href='http://automationpractice.com/index.php?controller=cart&add=1&id_product=2&token=d09947e4bad6c337f454257954341e3d']")
    @CacheLookup
    private WebElement addToCart2;

    @FindBy(css = "a[href='http://automationpractice.com/index.php?controller=cart&add=1&id_product=3&token=d09947e4bad6c337f454257954341e3d']")
    @CacheLookup
    private WebElement addToCart3;

    @FindBy(css = "a[href='http://automationpractice.com/index.php?controller=cart&add=1&id_product=4&token=d09947e4bad6c337f454257954341e3d']")
    @CacheLookup
    private WebElement addToCart4;

    @FindBy(css = "a[href='http://automationpractice.com/index.php?controller=cart&add=1&id_product=5&token=d09947e4bad6c337f454257954341e3d']")
    @CacheLookup
    private WebElement addToCart5;

    @FindBy(css = "a[href='http://automationpractice.com/index.php?controller=cart&add=1&id_product=6&token=d09947e4bad6c337f454257954341e3d']")
    @CacheLookup
    private WebElement addToCart6;

    @FindBy(css = "a[href='http://automationpractice.com/index.php?controller=cart&add=1&id_product=7&token=d09947e4bad6c337f454257954341e3d']")
    @CacheLookup
    private WebElement addToCart7;

    @FindBy(css = ".button-medium > span")
    @CacheLookup
    private WebElement PrToCh;

    @FindBy(css = ".button:nth-child(4) > span")
    @CacheLookup
    private WebElement PrToCh1;
    ...
    public WomenPage clickAddToCart1Link(){
    	...
    	actions.moveToElement(addToCart1);
        addToCart1.click();
        return this;
    }
     ...
     * @return the WomenPage class instance.
     */
    public WomenPage clickPrToChLink1() {
    	Actions actions = new Actions(driver);
    	actions.moveToElement(PrToCh);
    	PrToCh.click();
        return this;
    }
     ...
     * @return the WomenPage class instance.
     */
    public WomenPage clickPrToCh1Link() {
    	PrToCh1.click();
    	Actions actions = new Actions(driver);
    	actions.moveToElement(PrToCh1); 
    	PrToCh1.click();
        return this;
    }
     ...
     * @return the WomenPage class instance.
     */
    public WomenPage clickChristianBaleLink() {
        christianBale.click();
        return this;
    }
    ...
    public WomenPage clickFadedShortSleeveLink() {
    	Actions actions = new Actions(driver);
    	actions.moveToElement(fadedShortSleeve);
     ...
     * @return the WomenPage class instance.
     */
    public WomenPage clickPrintedDress3Link() {
        printedDress3.click();
        return this;
    }
     ...
     * @return the WomenPage class instance.
     */
    public WomenPage clickSearchButton1() {
        search.click();
        return this;
    }
     ...
     *
     * @return the http://automationpractice.com/index.php?id_category&#x3D;3&amp;controller&#x3D;category class instance.
     */
