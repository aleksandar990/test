...
public class ShippingPage {
    ...
    @FindBy(name = "delivery_option[479645]")
    @CacheLookup
     ...
     * @return the ShippingPage class instance.
     */
    public ShippingPage clickChristianBaleLink() {
        christianBale.click();
        return this;
    }
     ...
     *
     * @return the http://automationpractice.com/index.php?controller&#x3D;order class instance.
     */

    /**
     * Set default value to Choose A Shipping Option For This Address Asd Radio Button field.
     *
     * @return the ShippingPage class instance.
     */
